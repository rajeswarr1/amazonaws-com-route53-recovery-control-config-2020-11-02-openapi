# AWS Route53 Recovery Control Config MCP Server

This MCP (Model Content Protocol) server provides access to AWS Route53 Recovery Control Config API functionality through HTTP, HTTPS, and STDIO transport modes.
