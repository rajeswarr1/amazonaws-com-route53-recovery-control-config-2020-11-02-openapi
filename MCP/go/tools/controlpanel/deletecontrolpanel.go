...
func DeletecontrolpanelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteControlPanelResponse
...
func CreateDeletecontrolpanelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_controlpanel_ControlPanelArn",
		mcp.WithDescription("Deletes a control panel."),
		mcp.WithString("ControlPanelArn", mcp.Required(), mcp.Description("The Amazon Resource Name (ARN) of the control panel.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletecontrolpanelHandler(cfg),
	}
}
