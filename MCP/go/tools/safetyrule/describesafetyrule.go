...
func DescribesafetyruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DescribeSafetyRuleResponse
...
func CreateDescribesafetyruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_safetyrule_SafetyRuleArn",
		mcp.WithDescription("Returns information about a safety rule."),
		mcp.WithString("SafetyRuleArn", mcp.Required(), mcp.Description("The ARN of the safety rule.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribesafetyruleHandler(cfg),
	}
}
